...
```{r, echo=FALSE}
embed_url("https://youtu.be/-gp_G88K_go") %>%
  use_align("center")
```
...
```{r, echo=FALSE}
embed_url("https://youtu.be/GWiEKmOHJ0c") %>%
  use_align("center")
```
...
```{r, echo=FALSE}
embed_url("https://youtu.be/oIJ696r_Auk") %>%
  use_align("center")
```
...
```{r, echo=FALSE}
embed_url("https://youtu.be/bB9JK5AjNN8") %>%
  use_align("center")
```
...
```{r, echo=FALSE}
embed_url("https://youtu.be/G3FTM4c9pl0") %>%
  use_align("center")
```
...
```{r, echo=FALSE}
embed_url("https://youtu.be/HXnjBII-re8") %>%
  use_align("center")
```
...
```{r, echo=FALSE}
embed_url("https://youtu.be/N0wMjbp6eVk") %>%
  use_align("center")
```
...
```{r, echo=FALSE}
embed_url("https://youtu.be/XZpwxeBQXxg") %>%
  use_align("center")
```
