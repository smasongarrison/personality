...
**The videos start on the next page.**  You can find the module playlist [here][pl-01]. 
...
Remember that to succeed in this course, you should be consuming ALL of the resources in the Explore and Engage sections. Please use the learning goals to organize your notes. Optional materials ARE explicitly marked as optional and are located in the "Extras" subsection

### Explore
* Readings
  * Chapter 1 from the Personality Puzzle "THE STUDY OF THE PERSON" 
	  *  [Norton Ebook Link][ppch1]
...
### Engage
* Activities
	* What's my Personality Activity
...
This sequence of videos introduces personality psychology. It is approximately XXX in length using this [neat webapp][ytplaylist].
...
# Activity: What's My Personality?  {#whatisactivity}
...
I (Mason) think that this test battery is the best and most comprehensive personality (and individual differences) questionnaire out there. Get started right [here](https://www.sapa-project.org/survey/start.php)
