...
```{r, echo=FALSE}
"https://www.youtube.com/watch?v=b_j5BSXFRx4" %>%
 embed_url() %>%
  use_align("center")
```
...
```{r, echo=FALSE}
"https://www.youtube.com/watch?v=D_AnB53MQ94" %>%
 embed_url() %>%
  use_align("center")
```
...
```{r, echo=FALSE}
"https://www.youtube.com/watch?v=Ervcry6uqHQ" %>%
 embed_url() %>%
  use_align("center")
```
...
```{r, echo=FALSE}
"https://www.youtube.com/watch?v=ZIJooF8YxHA" %>%
 embed_url() %>%
  use_align("center")
```
