...
```{r, echo=FALSE}
embed_url("https://youtu.be/d71LYIGtFbk") %>%
  use_align("center")
```
...
```{r, echo=FALSE}
embed_url("https://youtu.be/vE_AjnSMjZU") %>%
  use_align("center")
```
...
```{r, echo=FALSE}
embed_url("https://youtu.be/AHESbZ9HCrw") %>%
  use_align("center")
```
...
```{r, echo=FALSE}
embed_url("https://youtu.be/PjAQ1WWnr_0") %>%
  use_align("center")
```
...
```{r, echo=FALSE}
embed_url("https://youtu.be/3xpGtURdlaQ") %>%
  use_align("center")
```
...
```{r, echo=FALSE}
embed_url("https://youtu.be/gH6DdttMTPw") %>%
  use_align("center")
```
...
```{r, echo=FALSE}
embed_url("https://www.youtube.com/watch?v=NVAk6DeYMmA") %>%
  use_align("center")
```
...
```{r, echo=FALSE}
embed_url("https://youtu.be/mgid-8XtZDE") %>%
  use_align("center")
```
...
```{r, echo=FALSE}
embed_url("https://youtu.be/7hWKaXT_4Vg") %>%
  use_align("center")
```
