...
```{r include = FALSE}
source("common.R")
funyoutube <- read.csv("data/funyoutube.csv", sep="")
...
```{r, echo=FALSE}
# Filler Video
video_url=sample_no_surprises(funyoutube$funyoutube)
embed_url(video_url) %>%
  use_align("center")
```

```{r, echo=FALSE}
var_url=slide_url(class_urls,"d17_functions")
...
```{r, echo=FALSE}
var_url=slide_url(class_urls,"d01_welcome","#1")
include_url(var_url, height = "400px")
```
