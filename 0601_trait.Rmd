...
```{r, echo=FALSE}
"https://www.youtube.com/watch?v=ukxPyA223cc" %>%
 embed_url() %>%
  use_align("center")
```
...
```{r, echo=FALSE}
"https://www.youtube.com/watch?v=2xBoyrhBh3I" %>%
 embed_url() %>%
  use_align("center")
```
...
```{r, echo=FALSE}
"https://www.youtube.com/watch?v=bdERzNy0XAA" %>%
 embed_url() %>%
  use_align("center")
```
...
```{r, echo=FALSE}
"https://www.youtube.com/watch?v=YyNHU5DP1Fk" %>%
 embed_url() %>%
  use_align("center")
```
...
```{r, echo=FALSE}
"https://www.youtube.com/watch?v=zzSdhlfbupc" %>%
 embed_url() %>%
  use_align("center")
```
```{r, echo=FALSE}
try(include_tweet("https://twitter.com/LarsUJohnson/status/1433227495474700295"))
```
