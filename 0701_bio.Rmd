...
```{r, echo=FALSE}
embed_url("https://youtu.be/Azpleyog8m8") %>%
  use_align("center")
```


## Brain-Based Research Methods (07.02)


<!-- not yet updated -->

```{r, echo=FALSE}
embed_url("https://youtu.be/MiX8-f-6hjE") %>%
  use_align("center")
```
...
```{r, echo=FALSE}
embed_url("https://youtu.be/gBymtP_A-cg") %>%
  use_align("center")
```

## The Frontal Lobe, Phineas Gage, and Psychosurgery (07.04)

<!-- not yet updated -->

```{r, echo=FALSE}
embed_url("https://youtu.be/xp-scBPhFMo") %>%
  use_align("center")
```


## The Biochemistry of Personality (07.05)
<!-- not yet updated -->

```{r, echo=FALSE}
embed_url("https://youtu.be/95CLJbFG58Q") %>%
  use_align("center")
```
...
```{r, echo=FALSE}
embed_url("https://youtu.be/-eQ9naRibcE") %>%
  use_align("center")
```
