...
You can find the module playlist [here][pl-02].
...
* Readings
	* Chapter 2 from the Personality Puzzle
		  *  [Norton Ebook Link][[ppch2_method]]
* Videos
...
# Lecture: Personality Research Methods {#methodsvideo}

This sequence of videos covers personality research methods. It is approximately 2 hours in length using this [neat webapp][ytplaylist]. Specifically,

* No of videos : 10

* Average length of video : 11 minutes, 49 seconds
...
<!-- updated-->
```{r, echo=FALSE}
embed_url("https://www.youtube.com/watch?v=E1e5sHbcVfE") %>%
  use_align("center")
```