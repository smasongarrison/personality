...
```{r, echo=FALSE}
"https://www.youtube.com/watch?v=A1MPuEiphJ4" %>%
 embed_url() %>%
  use_align("center")
```
...
```{r, echo=FALSE}
"https://www.youtube.com/watch?v=LyuIfx2ft-w" %>%
 embed_url() %>%
  use_align("center")
```
...
```{r, echo=FALSE}
"https://www.youtube.com/watch?v=BGX6csdSgvE" %>%
 embed_url() %>%
  use_align("center")
```
...
```{r, echo=FALSE}
"https://www.youtube.com/watch?v=eKb-HONj-Ds" %>%
 embed_url() %>%
  use_align("center")
```
