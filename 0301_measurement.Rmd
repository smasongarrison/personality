...
This sequence of videos introduces personality assessment. It is approximately 2.5 hours in length using this [neat webapp][ytplaylist]. Specifically,

* No of videos : 5

* Average length of video : 28 minutes, 13 seconds

* Total length of playlist : 2 hours, 21 minutes, 8 seconds
...
```{r, echo=FALSE}
embed_url("https://www.youtube.com/watch?v=k8uGttEdKgk") %>%
  use_align("center")
```
