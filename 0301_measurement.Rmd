...
This module focuses on personality assessment, evaluation, and ethics. Please watch the videos and work your way through the notes. **The videos start on the next page.**  You can find the module playlist [here][pl-03]. Most of the slides used to make the videos in this module can be found in the [slides repo][slides]. 
...
```{r, echo=FALSE}
embed_url("https://www.youtube.com/watch?v=03lnPLND52k") %>%
  use_align("center")
```
