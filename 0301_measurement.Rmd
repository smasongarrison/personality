...
```{r, echo=FALSE}
embed_url("https://youtu.be/ym35piQGiGg") %>%
  use_align("center")
```
...
```{r, echo=FALSE}
embed_url("https://youtu.be/Po4UBLMjkwE") %>%
  use_align("center")
```
...
```{r, echo=FALSE}
embed_url("https://youtu.be/c79D9ye6u0I") %>%
  use_align("center")
```
...
```{r, echo=FALSE}
embed_url("https://youtu.be/kgTPg8QasEE") %>%
  use_align("center")
```
...
```{r, echo=FALSE}
embed_url("https://youtu.be/T98LVErpNmI") %>%
  use_align("center")
```

```{r, echo=FALSE}
include_tweet("https://twitter.com/MaartenvSmeden/status/1434619122189545472")
```
...
```{r, echo=FALSE}
embed_url("https://youtu.be/z3BJ-MrITeQ") %>%
  use_align("center")
```
...
```{r, echo=FALSE}
embed_url("https://youtu.be/JouO7-iLVpc") %>%
  use_align("center")
```
